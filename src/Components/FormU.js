      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-7">
            ...
            <div class="mt-3"><p className="blueText"><b>Select a manifest that you like to import</b></p></div>
            <div>
              <DragDrop /> {/* Componente DragDrop */}
            </div>

            <div className='col-lg-6' style={{ borderTop: '1px solid #ccc', marginTop: '10px' }}></div>
            <div><p class="mt-3"><b>Elapse Date Checking:</b></p>
              <p class="mt-2">No Elapse Dates!</p>
            </div>
            <div className='col-lg-6' style={{ borderTop: '1px solid #ccc', marginTop: '10px' }}></div>
            <div class="mt-3"><p className="blueText"><b>Tolerance Windows</b></p></div>
          ...
          <div className="col-lg-5">
            <p class="mt-0 mb-1"><b>Split Schedule Using Social Distance?</b></p>
            ...
            <div><p class="mt-3"><b>Location Checking</b></p>
              <p class="mt-2 mb-1">All Available!</p>
            </div>
            <div className='col-lg-9' style={{ borderTop: '1px solid #ccc', marginTop: '0px' }}></div>
        ...
        <div className="container" style={{ marginTop: '-40px' }}>
          ...
          <div className="row justify-content-center">
            <div className="col-md-auto">
              <button className="btn btn-primary btn-lg">Continue Import</button>
            </div>
            <div className="col-md-auto">
